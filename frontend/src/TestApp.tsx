function TestApp() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-700 to-slate-900 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-2xl p-12 max-w-md">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-cyan-100 border border-cyan-300 text-cyan-800 px-4 py-3 rounded-lg">
